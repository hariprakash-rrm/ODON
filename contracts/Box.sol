    ...
    PausableUpgradeable
{
    ...
    function initialize() public initializer {
        ...
        maximumSwapableLiquidityAmount = 100 * 10**18;
    ...
    // set tax fee percent(i.e marketing fee, charityfee,developer fee,burn fee & liquidity fee)
    ...
    function withdrawBNBFromContract() external onlyOwner {
        ...
        // withdraw token from the contract address
    function withdrawTokenFromContract() external onlyOwner {
        uint256 contractAddressToken = _balances[address(this)];
        uint256 withdrawlAmount = contractAddressToken - swapableLiquidityFeeAmount - burnableFeeAmount;
